...
public class IntegrationController {
    ...
    // TODO: At the moment the resource response actually shares the type
    // (ContainersResponse) with the containers response. Change this.
    ...
    @ApiResponse(responseCode = "200", description = "Returns JSON with basic info of created suggestion, or an error string", content = {
            @Content(schema = @Schema(implementation = ConceptSuggestionResponse.class)) })
    ...
    @ApiResponse(responseCode = "200", description = "Returns JSON with terminology list", content = {
            @Content(schema = @Schema(implementation = ContainerResponseWrapper.class)) })
    ...
    @ApiResponse(responseCode = "404", description = "Service not found")
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Search parameters as JSON request object. Contains mostly equivalent options as GET variant query parameters.", required = true)
    ...
    @ApiResponse(responseCode = "200", description = "Returns JSON with concept list", content = {
            @Content(schema = @Schema(implementation = ResourceResponseWrapper.class)) })
